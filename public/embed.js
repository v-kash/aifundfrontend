(function() {
  ...
  const config = {
    ...
    botAvatar: scriptTag.getAttribute('data-bot-avatar') || 'http://localhost:3000/default-bot.png', 
    welcomeMsg: scriptTag.getAttribute('data-welcome-msg') || 'Hello! How can I help you today?',
